(function (){
	...
	addCSS();
	createTape(['cat.jpg', 'dog.jpg', 'rat.jpg', 'cat.jpg', 'dog.jpg', 'rat.jpg'], ['cat.html', 'dog.html', 'rat.html', 'cat.html', 'dog.html', 'rat.html']);
	...
	function createTape(imgList, lnkList){
		...
		for (let i = 0; i < imgList.length; i++) {
			html += '<span class="img-wrap"><img src="' + imgList[i] + '" alt="img' + i + '">';
			html += '<span class="img-btn"><a href="' + imgList[i] + '" download>Download</a>';
			if (lnkList) html += '<a href="' + lnkList[i] + '">Link</a>';
